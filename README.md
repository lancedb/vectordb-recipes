...
| Project Name                                        | Description                                                                                                          | Screenshot                                |
|-----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|-------------------------------------------|
| [Sentance auto complete](https://github.com/lancedb/vectordb-recipes/tree/main/applications/node/sentance_auto_complete) | sentance auto complete  app using lanchain.js with LanceDB, allows you to get real time relevant auto complete of sentance suggestions and facts based on you written text to help you with your writing. It also support file upload in PDF format. You can also swith between gpt models.              | ![Sentance auto complete](https://github.com/lancedb/assets/blob/main/recipes/sentance_Auto_complete.gif) |
