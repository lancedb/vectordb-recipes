...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", type=str, default="https://harrypotter.fandom.com/wiki/Hogwarts_School_of_Witchcraft_and_Wizardry", help="URL of the document")
    parser.add_argument("--embed_model", type=str, default="mixedbread-ai/mxbai-embed-large-v1", help="Embedding model")
    parser.add_argument("--uri", type=str, default="~/tmp/lancedb_hogwarts_12", help="URI of the vector store")
    parser.add_argument("--force_create_embeddings", type=bool, default=False, help="Force create embeddings")
